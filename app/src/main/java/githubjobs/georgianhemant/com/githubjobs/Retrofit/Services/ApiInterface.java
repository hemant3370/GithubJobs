package githubjobs.georgianhemant.com.githubjobs.Retrofit.Services;
...
//
    ...
    @GET("/positions.json")
    Call<List<PositionResponse>> getPositions(@Query("description") String position, @Query("location") String location );
//
//
//
//    @Headers("Content-Type: application/json")
